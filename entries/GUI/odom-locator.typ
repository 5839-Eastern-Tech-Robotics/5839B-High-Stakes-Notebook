...
To do this we first planned out the GUI with the same color theme as the auton selector, and orange as accents. We used an online image editor to do this and used layers to represent different modes. Our finished prototype can be seen in /* refence figure */.
...
While coding, I followed the style of robodash's existing views 
